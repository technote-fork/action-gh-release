...
const upload = (octokit, context, release, path) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (yield octokit.repos.uploadReleaseAsset(Object.assign(Object.assign({}, context.repo), { baseUrl: release.upload_url.replace(/\/repos\/.+$/, ''), 'release_id': release.id, name, 
