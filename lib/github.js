...
class GitHubReleaser {
    ...
    getReleaseByTag(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.octokit.rest.repos.getReleaseByTag(params)).data;
        });
    }
    /**
     * @param {object} params params
    ...
    createRelease(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.octokit.rest.repos.createRelease(params)).data;
        });
    }
    /**
     * @param {object} params params
    ...
    updateRelease(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.octokit.rest.repos.updateRelease(params)).data;
        });
    }
    /**
     * @param {object} params params
    ...
    allReleases(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.octokit.paginate(this.octokit.rest.repos.listReleases, params)).map(item => item);
        });
    }
}
...
exports.asset = asset;
const upload = (octokit, context, release, path) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, size, mime, file } = (0, exports.asset)(path);
    console.log(`⬆️ Uploading ${name}...`);
    const assets = yield octokit.paginate(octokit.rest.repos.listReleaseAssets, Object.assign(Object.assign({}, context.repo), { 'release_id': release.id }));
    const duplicated = assets.find(assets => assets.name === name);
    if (duplicated) {
        yield octokit.rest.repos.deleteReleaseAsset(Object.assign(Object.assign({}, context.repo), { 'asset_id': duplicated.id }));
    }
    return (yield octokit.rest.repos.uploadReleaseAsset(Object.assign(Object.assign({}, context.repo), { baseUrl: release.upload_url.replace(/\/repos\/.+$/, ''), 'release_id': release.id, name, 
...
const release = (config, context, releaser) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (error.status === 404) {
            try {
                ...
                return yield releaser.createRelease(Object.assign(Object.assign({}, context.repo), { 'tag_name': tag, name: config.input_name || tag, body: (0, util_1.releaseBody)(config), draft: config.input_draft, prerelease: config.input_prerelease }));
            }
            catch (error) {
                // presume a race with competing metrix runs
                console.log(`⚠️ Octokit release failed with status: ${error.status}, retrying...`);
                return yield (0, exports.release)(config, context, releaser);
            }
        }
        else {
